...
namespace Queries
{
    ...
    {
        private static class LINQExamples
        {
            public static void CrossJoinExtensionExample(PlutoContext context)
            {
            ...
            public static void GroupJoinExtensionExample(PlutoContext context)
            {
            ...
            public static void InnerJoinExtensionExample(PlutoContext context)
            {
            ...
            public static void GroupExtensionExample(PlutoContext context)
            {
            ...
            public static void DistinctExtensionExample(PlutoContext context)
            {
            ...
            public static void BasicExtensionsExample(PlutoContext context)
            {
                var query = context.Courses
                    .Where(c => c.Level == 1)
            ...
            public static void CrossJoinExample(PlutoContext context)
            {
            ...
            public static void GroupJoinExample(PlutoContext context)
            {
                var query = from a in context.Authors
            ...
            public static void InnerJoinExample(PlutoContext context)
            {
            ...
            public static void GroupExample(PlutoContext context)
            {
                var query = from c in context.Courses
